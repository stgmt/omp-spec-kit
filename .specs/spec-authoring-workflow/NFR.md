...
## NFR-SAFETY-1 — Safety and fail-closed behavior
...
## NFR-DURABILITY-1 — Atomicity and durability
...
## NFR-CONCURRENCY-1 — Concurrency and bounded waiting
...
## NFR-PERFORMANCE-1 — Performance and resource bounds
...
## NFR-PRIVACY-1 — Privacy and redaction
...
## NFR-COMPATIBILITY-1 — Compatibility and byte conservation
...
## NFR-OBSERVABILITY-1 — Observability without hidden state
...
## NFR-MAINTAINABILITY-1 — Maintainability

One schema, one validator composition, one root resolver, one transaction authority, and one task transition table SHALL serve the MCP authoring facades. The existing OMP extension SHALL remain read-only. Duplicate authoring adapters, implementations, or compatibility shims are prohibited.

## NFR-READINESS-1 — Honest readiness
