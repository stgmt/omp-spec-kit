...
|---|---|---|---|---|---|
| [FR-1](FR.md#fr-1-one-server-semantic-free-read-projection-that-does-not-shrink-mcp) | Semantic-free read projection; MCP eight tools remain | [AC-1.1](ACCEPTANCE_CRITERIA.md#ac-11-fr-1-lsp-is-a-semantic-free-read-projection) | `@feature1` | [US-2](USER_STORIES.md#us-2-agent-navigating-spec-definitions-through-lsp-primitives), [UC-2](USE_CASES.md#uc-2-navigate-from-a-cross-reference-to-its-definition) | Specified |
...
| [FR-7](FR.md#fr-7-this-stage-forbids-a-step-binding-layer) | No step-binding layer in this stage | [AC-7.1](ACCEPTANCE_CRITERIA.md#ac-71-fr-7-this-stage-ships-no-step-binding-diagnostics) | `@feature7` | [US-6](USER_STORIES.md#us-6-release-owner-proving-step-layer-absence) | Specified |
