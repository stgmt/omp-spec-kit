...
**Acceptance:** [AC-2.1](ACCEPTANCE_CRITERIA.md#ac-21-fr-2-no-mutation-and-code-actions-propose-only)
...
**Acceptance:** [AC-6.1](ACCEPTANCE_CRITERIA.md#ac-61-fr-6-hover-returns-kernel-node-body-and-scenario-provenance)
...
**Acceptance:** [AC-7.1](ACCEPTANCE_CRITERIA.md#ac-71-fr-7-step-layer-uses-bundled-libraries-not-external-server)
...
**Acceptance:** [AC-9.1](ACCEPTANCE_CRITERIA.md#ac-91-fr-9-incremental-re-evaluation-meets-budget)
...
**Acceptance:** [AC-10.1](ACCEPTANCE_CRITERIA.md#ac-101-fr-10-scope-is-contained-and-absence-is-honest)
...
**Acceptance:** [AC-12.1](ACCEPTANCE_CRITERIA.md#ac-121-fr-12-oracle-parity-proves-step-verdict-agreement)
