...
- `tests/fixtures/registry/repo-b/` — second namespace for scope isolation (AC-3.1, SCEN-multi-project-routing).
...
- Compose fixture: minimal `projects.json` + fake bot credentials for `docker compose up` smoke (AC-15.1).
