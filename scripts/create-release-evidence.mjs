...
export async function createReleaseEvidence({
  ...
  const requiredScenarios = requiredScenarioMultiplicity(await readFile(path.join(resolveSpecsBearingRoot({ baseDir: repositoryRoot }), ".specs", "plugin-distribution", "plugin-distribution.feature"), "utf8"));
