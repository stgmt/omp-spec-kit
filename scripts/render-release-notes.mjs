...
export async function renderReleaseNotes({ candidatePath, evidencePath, tag, repositoryRoot, resolveTagCommit }) {
  ...
  return [
    ...
    "- This candidate's read-only v0.3 first slice / candidate identity contains exactly eight MCP tools; later gated capabilities may add names without rewriting this receipt.",
    "",
    "## Verified candidate",
    "",
