...
import { AUTHORING_TOOL_CONTRACTS, EVIDENCE_TOOL_CONTRACTS, READ_COMPLETE_TOOL_CONTRACTS, TOOL_CONTRACTS } from "../src/adapters/tool-contracts.js";
...
if (TOOL_CONTRACTS.length !== 8 || READ_COMPLETE_TOOL_CONTRACTS.length !== 23 || EVIDENCE_TOOL_CONTRACTS.length !== 25 || AUTHORING_TOOL_CONTRACTS.length !== 49) fail("stage contract counts drifted from 8/23/25/49");
console.log("verified spec port: census=46; contracts=8/23/25/49");
